...
# --- Tool Implementations (v6/v7 Shared) ---
...
def run_mission(prompt_input=None, model_id=DEFAULT_MODEL, persona_path=DEFAULT_PERSONA):
    print("🤖 INITIALIZING GEMINI CODE AUTO-TEST SYSTEM (v7 - HYBRID INPUT MODE)...")
    ...
    if os.path.exists(persona_path):
        ...
        system_instruction = (
            f"{raw_persona}\n\n"
            "SYSTEM OVERRIDE v7 (DIAGNOSTICS):\n"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run Gemini Auto-Test Agent v7")
    ...
    run_mission(args.prompt_input, args.model, args.persona)
